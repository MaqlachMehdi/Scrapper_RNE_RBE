...
class InfogreffeClient(BaseScraper):
    ...
    def _is_company_profile_page(self, page: Page) -> bool:
        if re.search(r"(entreprise|societe|documents|etablissements|dirigeants|analyse-financiere)", page.url, re.I):
            return True
    ...
    def _try_manual_login(self, page: Page, reason: str) -> bool:
        ...
        return self._is_logged_in(page) and not self._is_cloudflare_block(page)
